...
export const Camera = ({ className = "", width = 32, height = 32 }) => (
  <svg
    ...
    aria-hidden
  >
    <path d="M9 7l1.2-2.4A2 2 0 0 1 12 3h0a2 2 0 0 1 1.8 1.1L15 7h4a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-7a3 3 0 0 1 3-3h4z" />
